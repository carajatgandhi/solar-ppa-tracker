...
COMPANY_PATTERNS = [
    "adani green", "renew power", "greenko", "acme solar",
    "tata power solar", "ntpc renewable", "torrent power",
    "amp energy", "waaree", "o2 power", "azure power",
    "hero future", "avaada", "sprng energy", "eden renewables",
    "ayana renewable", "cleanmax", "ib vogt", "ostro energy",
    "serentica", "amp solar", "engie", "sembcorp",
    "powerica", "vena energy", "sterlite power"
]
...
def extract_company(text):
    ...
    for company in COMPANY_PATTERNS:
        if company in text_lower:
            ...
            return text[idx:idx+len(company)].title()
    return None
...
def run_scraper():
    ...
    for article in all_articles:
        ...
        company  = extract_company(title) or "⚠️ Review needed"
        ...
        entry = {
            "company":  company,
            "state":    state or "⚠️ Review needed",
